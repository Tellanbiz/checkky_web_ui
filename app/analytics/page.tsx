      ...
      <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={performanceData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="completed" stroke="#16A34A" name="Completed" strokeWidth={2} />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Checklist distribution by category</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={teamPerformance} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="completed" fill="#16A34A" name="Tasks Completed" />
                ...
                .map((member, index) => (
                  <div key={member.name} className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">Quality: {member.quality}%</p>
                    </div>
              ...
              {[
                ...
                <div key={item.area} className="flex items-center justify-between">
                  ...
                  <Badge
                    ...
                    className={item.risk === "Medium" ? "bg-yellow-100 text-yellow-800" : ""}
                  >
                    {item.risk}
                  </Badge>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-3 bg-green-50 rounded-lg">
                <p className="text-sm font-medium text-green-800">Completion rates improved by 5% this month</p>
                <p className="text-xs text-green-600">Great work on livestock inspections!</p>
              </div>
              <div className="p-3 bg-yellow-50 rounded-lg">
                <p className="text-sm font-medium text-yellow-800">Equipment checks need attention</p>
                <p className="text-xs text-yellow-600">3 overdue maintenance tasks</p>
              </div>
              <div className="p-3 bg-blue-50 rounded-lg">
                <p className="text-sm font-medium text-blue-800">New team member onboarded</p>
                <p className="text-xs text-blue-600">Lisa Brown joined the auditing team</p>
              </div>
            </div>
          </CardContent>
        </Card>
